...
namespace SpiritEngine {
	...
	public:
		...
		static void DrawLine(const glm::vec3& positionI, const glm::vec3& positionJ, float width, const glm::vec4& color);

		static void DrawTriangle(const glm::mat4& transform, const glm::vec4& color);

		static void DrawLine(const glm::mat4& transform, const glm::vec4& color);
