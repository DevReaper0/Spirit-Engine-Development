...
namespace SpiritEngine {
	...
	public:
		...
		// TODO: temporary whilst SpiritEngine Audio is in early dev
	...
	private:
		...
		static AudioSource LoadAudioSourceAiff(const std::string& filename);
		static AudioSource LoadAudioSourceMidi(const std::string& filename);
		static AudioSource LoadAudioSourceCda(const std::string& filename);
		static AudioSource LoadAudioSourceSpirit(const std::string& filename);
	};
